   ...
   !End Do
    ...
    !--------------------------------
      ...
      Do qqi = 1, iQRPA_LEN                             !!!Q: make QRPA X and Y complex
         ...
         Norm_N = Norm_N   & 
                   +  realpart(CQRPA_XN_c(QQi))* realpart(CQRPA_XN_c(QQi)) + imagpart(CQRPA_XN_c(QQi))* imagpart(CQRPA_XN_c(QQi)) &
                   -  realpart(CQRPA_YN_c(QQi))* realpart(CQRPA_YN_c(QQi)) - imagpart(CQRPA_YN_c(QQi))* imagpart(CQRPA_YN_c(QQi))
         Norm_P = Norm_P   & 
                   +  realpart(CQRPA_XP_c(QQi))* realpart(CQRPA_XP_c(QQi)) + imagpart(CQRPA_XP_c(QQi))* imagpart(CQRPA_XP_c(QQi)) &
                   -  realpart(CQRPA_YP_c(QQi))* realpart(CQRPA_YP_c(QQi)) - imagpart(CQRPA_YP_c(QQi))* imagpart(CQRPA_YP_c(QQi))
      end do
